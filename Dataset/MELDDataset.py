...
class MELDDataset(Dataset):
    ...
    def __init__(self, train = True):
        ...
        self.testVid, _ = pickle.load(open('/home/xrl/MultiEMO-ACL2023-main/Data/MELD/Speakers.pkl', 'rb'))
        ...
        '''
        self.videoText = pickle.load(open('/home/xrl/MultiEMO-ACL2023-main/Data/MELD/TextFeatures.pkl', 'rb'))
        self.videoAudio = pickle.load(open('/home/xrl/MultiEMO-ACL2023-main/Data/MELD/AudioFeatures.pkl', 'rb'))
        self.videoVisual = pickle.load(open('/home/xrl/MultiEMO-ACL2023-main/Data/MELD/VisualFeatures.pkl', 'rb'))

        self.keys = [x for x in (self.trainVid if train else self.testVid)]
        self.len = len(self.keys)
        # 打印训练集和测试集的keys长度
        if train:
            print(f"Training set keys length: {len(self.trainVid)}")
        else:
            print(f"Test set keys length: {len(self.testVid)}")
