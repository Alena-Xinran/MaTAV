...
class MultiEMO(nn.Module):
    ...
    def forward(self, texts, audios, visuals, speaker_masks, utterance_masks, padded_labels):
        ...
        mask = padded_labels[padded_labels != -1]
        print(mask.shape)
        ...
        mamba_outputs = self.mlp(fc_outputs)
        print(mamba_outputs.shape)
        return fused_text_features, fused_audio_features, fused_visual_features, fc_outputs, mamba_outputs